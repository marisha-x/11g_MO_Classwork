# 11g_MO_Classwork
Examples and Shares
на 14 и 16.04.2026 - за учебна практика по МО използвай линка:
https://colab.research.google.com/drive/1HgmhXqHxhiiPNh88k_WK3yDE-UloTiS5?usp=sharing
...
А сега да упражним темите за ИЗД. 

Използвай шаблона от 19 - 28.05.2026 г:
https://colab.research.google.com/drive/1rTVEWVfId1FXXu9cM2mdWSDo2rijp_kl?usp=sharing

🎯 ЦЕЛИ НА ПРАКТИКАТА
След тази практика ще можете да:

✅ Откривате липсващи стойности с pandas
✅ Прилагате различни методи за импутация
